...
The [Compromised password blocking](../mupwned/) plugin checks passwords against the
...
The [Privileged sessions](../musudo/) plugin allows administrators and privileged users to log in with a
...
The [Log-in-as via Incognito window](../muloginas/) plugin enhances the standard Moodle "Log in as" feature. Instead
