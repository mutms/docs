---
title: Programs
description: An overview of the MuTMS Programs plugin for Moodle LMS.
---
...
- **Program content** — hierarchical structure of courses, credit frameworks,
  offline activities, and nested sets with flexible sequencing rules
- **Allocation** — multiple allocation sources including manual assignment,
  cohort membership, and allocation from an external database
- **Scheduling** — advanced scheduling settings per program with precise
  start and end dates and access controls
- **Automated course enrolment** — learners are automatically enrolled into
