---
title: What is MuTMS?
description: An overview of the MuTMS plugin suite for Moodle LMS.
---
...
their own users, courses, branding, and administrators — without running
separate instances.

## Why MuTMS?

MuTMS is built for organisations that need to manage learning for multiple
distinct groups from one place: training providers serving multiple clients,
corporations with separate business units, or educational institutions with
